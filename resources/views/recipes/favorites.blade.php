<x-guest-layout>
    <div class="max-w-6xl mx-auto">
        <h1 class="text-2xl text-gray-800 px-8">{{__('My favorite recipes')}}</h1>
        <p class="mt-2 text-gray-600 text-sm px-8">
            {{__('A collection of all your favorite recieps.')}}
        </p>
    </div>
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 overflow-hidden sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-6">
                ...
                @empty
                    <p class="mx-8 text-lg text-green-600">{{__('You haven\'t favorited any recipes yet')}}</p>
                @endforelse
            </div>
        </div>
    </div>
