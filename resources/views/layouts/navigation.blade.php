...
<nav class="flex w-full justify-between text-lg">
    <!-- Main Menu -->
    <div class="w-full bg-white z-50 hidden md:flex md:items-center md:justify-between relative" id="navbar">
        <div class="flex">
    ...
    <button id="hamburger-menu-button" class="p-3 ml-auto md:hidden text-green-600 hover:text-green-400">
...
<div id="mobile-menu" class="w-full hidden bg-white bg-opacity-90 md:hidden absolute left-0 top-[100%] z-40 h-screen">
